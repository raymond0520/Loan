...
-(void)setup {
    ...
    percentLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 70, 70)];
    [percentLabel setFont:[UIFont systemFontOfSize:16]];
    [percentLabel setTextColor:[UIColor colorWithRed:60/255.0 green:63/255.0 blue:71/255.0 alpha:1.0]];
...
- (void)setPercent:(int)percent Percent1:(int)percent1 animated:(BOOL)animated {
    ...
    CGFloat floatPercent1 = percent1 / 100.0;
    floatPercent1 = MIN(1, MAX(0, floatPercent1));
    
    percentLayer.percent = floatPercent;
    percentLayer.percent1 = floatPercent1;
    [self setNeedsLayout];
    [percentLayer setNeedsDisplay];
